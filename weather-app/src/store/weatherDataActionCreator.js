import { getCurrentWeatherData, getHourlyForecastData, getHourlyForecastDataSity, getMoreWeatherData, getUserIP, getWeatherBySityName } from "../axios/axiosRequest";
import { SET_IS_LOADING, USER_LOCATION_FOR_IP, WEATHER_FORECAST_DATA_FOR_GEOLOCATION, WEATHER_FORECAST_DATA_FOR_SITY_NAME, WEATHER_FOR_WEEK, WEATHER_HOURLY } from "./weatherDataAction";
...
export const getWeatherForWeek = () => async (dispatch, getStore) =>{
        ...
        console.log(weatherData.locationData.latitude, weatherData.locationData.longitude);
